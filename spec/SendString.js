 ...
 */
describe('SendString component', function() {
  let c = null;
  let ins = null;
  let string = null;
  let out = null;
  before(function(done) {
    ...
    return loader.load('strings/SendString', function(err, instance) {
  ...
  return describe('when receiving a bang', () => it('should send the string out with banged brackets', function(done) {
    const expected = [
      '< a',
      'DATA Hello There',
      '>'
